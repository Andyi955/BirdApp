...
class Login : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View) {
        val i = v.id
        when (i) {
            R.id.emailCreateAccountButton -> createAccount(editEmail.text.toString(), editPassword.text.toString())
            R.id.emailSignInButton -> signIn(editEmail.text.toString(), editPassword.text.toString())
